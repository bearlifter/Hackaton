...
function TransferButton(props: Props) {
  ...
  const { api } = useApi();
   ...
   // Add your programID
  const programIDFT =
    "0x0a2722ffa1c53fe24721c22d32be559ef4d21dd6abf99e77ce035b3c1ae05cda";
  ...
  const message: any = {
    ...
    payload: {
      transfer: [
        decodeAddress("0x8e7c55dded8964d24e68df06a289be0bfbb93a356d9ae5d7c2ce03cee820e942"),
        decodeAddress("0x4e53b0567d3e39052a7fd2e30a73992367d98bdf0fddf4b928ecb8e46e6e4b2f"),
        props.amount,
      ],
    },
    gasLimit: 899819245,
